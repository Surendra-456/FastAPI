...
# aiosmtplib.send call will use the settings from the config.py file to send the email using the specified mail server, port, username, password, and TLS settings.
